...
unsigned char Recuperation::hexchr2bin(const char hex)
{
...
void Recuperation::hexStringToBin(unsigned char* out, const char* hexPrivate) {
    for (int i = 0; i < 32; i++) {
...
char* Recuperation::binToHexString(char* out, const unsigned char* bin, size_t len)
{
    size_t  i;
...
string Recuperation::Message_Signature(string message, string private_key) {
